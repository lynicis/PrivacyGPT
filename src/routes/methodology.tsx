        ...
        <div className="space-y-12">
          ...
          <Card className="bg-muted/30">
            ...
            <CardContent className="space-y-6">
              {/* Weights Table */}
              <div>
                <h3 className="text-sm font-semibold mb-2">Default Weights</h3>
              ...
              <div className="space-y-3">
                <h3 className="text-sm font-semibold">Category Scoring Rules</h3>
                
                <div className="space-y-3 text-xs text-muted-foreground">
                  <div>
                    <strong className="text-foreground">1. Model Training by Default</strong>
                    <ul className="list-disc pl-4 mt-1 space-y-0.5">
                      <li>100 pts: Private by default (no training on user chats).</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-4 mt-1 space-y-0.5">
                      ...
                      <li>40 pts: Requires manual form submission or is restricted to EU/UK.</li>
                      <li>0 pts: No opt-out available.</li>
                    </ul>
                  </div>

                  <div>
                    <strong className="text-foreground">3. Data Retention Period</strong>
                    <ul className="list-disc pl-4 mt-1 space-y-0.5">
                      <li>100 pts: Zero retention (chats deleted immediately).</li>
                      <li>80 pts: Short retention (under 30 days, e.g., when history is off).</li>
                      <li>50 pts: Medium retention (30 days to 18 months).</li>
                      <li>0 pts: Long, indefinite, or 5-year research retention.</li>
                    </ul>
                  </div>

                  <div>
                    <strong className="text-foreground">4. Deletion Rights</strong>
                    <ul className="list-disc pl-4 mt-1 space-y-0.5">
                      <li>100 pts: Full account & thread deletion processed within 30 days.</li>
                      <li>50 pts: Partial deletion (e.g., chats are deleted but model-ingested training posts cannot be purged).</li>
                      <li>0 pts: No deletion requests honored.</li>
                    </ul>
                  </div>

                  <div>
                    <strong className="text-foreground">5. Third-Party Sharing</strong>
                    <ul className="list-disc pl-4 mt-1 space-y-0.5">
                      <li>100 pts: Stored in isolated customer VPC, zero third-party sharing.</li>
                      <li>85 pts: Shared with infrastructure/model providers under strict non-training, security contracts.</li>
                      <li>20 pts: Shared for targeted advertising or across general consumer platforms.</li>
                    </ul>
                  </div>

                  <div>
                    <strong className="text-foreground">6. Human Review of Chats</strong>
                    <ul className="list-disc pl-4 mt-1 space-y-0.5">
                      <li>100 pts: No human review.</li>
                      <li>80 pts: Human review is restricted to abuse/security flags or safety reports.</li>
                      <li>30 pts: Chats are sampled and reviewed for model annotation/improvement.</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t border-border pt-3 text-xs">
                ...
                <code className="block bg-background p-2 border border-border text-center overflow-x-auto text-[11px]">
